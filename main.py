...
def main():
    ...
    data1 = '{"discordId":"'+matisseId+'","discordUsername":"matisse","targetPicture":"'+targetLocalImage+'","prompt":"'+textToRiffWith+'","id":'+str(random.randint(1e4, 9e4))+', "accessToken": "'+DISCORD_TOKEN+'"}'
